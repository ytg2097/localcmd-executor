...
import io.ac.stream.commandbuidler.CommandAssembly;
import io.ac.stream.commandbuidler.CommandBuidler;
import io.ac.stream.config.ProgramConfig;
import io.ac.stream.data.CommandTasker;
import io.ac.stream.data.TaskDao;
import io.ac.stream.handler.TaskHandler;

import java.util.Collection;
import java.util.Map;

import static io.ac.stream.util.PropertiesUtil.load;
...
//    static final ProgramConfig config = load("loadFFmpeg.properties", ProgramConfig.class);
    static final ProgramConfig config = new ProgramConfig();
