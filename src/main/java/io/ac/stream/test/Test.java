package io.ac.stream.test;

import io.ac.stream.CommandManager;
import io.ac.stream.CommandManagerImpl;
import io.ac.stream.commandbuidler.CommandBuidlerFactory;
...
public class Test {
	...
	public static void test2() throws InterruptedException {
		...
		//测试多个任何同时执行和停止情况
		//默认方式发布任务
		manager.start("tomcat", "ffmpeg -re  -rtsp_transport tcp -i rtsp://admin:HuaWei123@120.224.2.211:36690/LiveMedia/ch1/Media1  -f flv -r 15 -s 1920*1080 -an rtmp://124.70.137.103:1935/live/test");
