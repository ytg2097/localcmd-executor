package io.ac.stream.util;


import io.ac.stream.data.CommandTasker;
import io.ac.stream.handler.OutHandler;
import io.ac.stream.handler.OutHandlerMethod;
...
public class ExecUtil {
	...
	public static void main(String[] args) {
		try{
			...
			Process exec = Runtime.getRuntime().exec("ffmpeg -re  -rtsp_transport tcp -i rtsp://admin:HuaWei123@120.224.2.211:36690/LiveMedia/ch1/Media1  -f flv -r 15 -s 1920*1080 -an rtmp://124.70.137.103:1935/live/test");
